...
curl --data '{"tag_name": "$vrelase","target_commitish": "master","name": "v$vrelease","body": "Release of version $vrelease","draft": false,"prerelease": false}' 
https://api.github.com/repos/JFernando1/AnalisisII-LAB/releases?access_token=:33f82ac39e7ba8448cffe26f2ac53d1cdf6b9854
